...
def job():
    ...
    headers = [
        'TIMESTAMP', 'TOTAL_CE_COI', 'TOTAL_PE_COI', 'TOTAL_COI', 'CE_RATIO',
        'PE_RATIO', 'PCR DIFF', 'PCR', 'SIGNAL'
    ]
    data = [
        timestamp_str, TOTAL_CE_COI, TOTAL_PE_COI, TOTAL_COI, CE_DIFF, PE_DIFF,
        PCR_DIFF, PCR, FINAL_SIGNAL
    ]
